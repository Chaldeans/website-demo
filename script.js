...
function updateCartUI() {
    ...
    if (cart.length === 0) {
        ...
        cartContainer.innerHTML = cart.map((item, index) => `
            ...
            <button onclick="clearCart()" style="background:none; border:none; color:#FF00005; font-size:10px; cursor:pointer; margin-top:10px; text-transform:uppercase; letter-spacing:1px;">[ Wipe Manifest ]</button>
        `;
